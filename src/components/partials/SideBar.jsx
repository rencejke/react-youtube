...
const SideBar = () => {
  return (
    ...
    <div>
    <aside className='side__header flex fixed flex-col justify-start mt-4 gap-3 pl-4 overflow-y-scroll custom-scroll max-h-[92vh] w-[13%]'>
         
          {/* 1st part sidebar */}
          <div className='flex flex-col  border-b-[1px] border-gray-400 gap-1 pb-3 w-[90%]'>

          <div className='flex flex-row items-center gap-5 p-2 activeHeader '>
          <IoMdHome className='text-[26px]'/>
          <span className='text-[14px] font-normal'>Home</span>
       </div>

          <div className='flex flex-row items-center gap-5 p-2 justify-start'>
          <SiYoutubeshorts className='text-[26px]'/>
          <span  className='text-[14px]  font-normal'>Shorts</span>
          </div>

          <div className='flex flex-row items-center gap-4 p-2 justify-start'>
